	...
	return (
		...
		>
			<div className='space-y-4'>
				<div>
					<label htmlFor='voucher' className='mb-2 block text-sm font-medium text-gray-300'>
						Aveți un voucher sau cardul de cadou?
					</label>
					<input
						type='text'
						id='voucher'
			...
			{isCouponApplied && coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-gray-300'>Voucher aplicat</h3>
			...
			{coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-gray-300'>Voucherul tău disponibil:</h3>
					<p className='mt-2 text-sm text-gray-400'>
						{coupon.code} - {coupon.discountPercentage}%
					</p>
				</div>
